...
- **WHEN** el usuario hace click en el valor numérico principal de una tarjeta de KPI referida a �rdenes (por ejemplo, "�rdenes Activas" u "�rdenes Estancadas")
...
- **WHEN** el usuario hace click en el valor numérico principal de la tarjeta de KPI de "Insumos bajo Stock M�nimo"

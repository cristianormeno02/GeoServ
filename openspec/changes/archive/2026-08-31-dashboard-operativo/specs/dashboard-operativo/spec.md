...
Proveer especificaciones de comportamiento y contratos de datos para los endpoints y componentes visuales del Dashboard Operativo de GeoServ, permitiendo monitorear la carga de trabajo, plazos, capacidad y riesgos de desabastecimiento o cobranza pendiente.

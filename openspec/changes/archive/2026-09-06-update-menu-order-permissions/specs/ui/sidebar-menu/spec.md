...
El sistema MUST restringir la visibilidad de los ítems del menú lateral según los roles del usuario autenticado. 
...
- **THEN** el sidebar solo muestra el ítem "Dashboard Cliente" bajo el grupo Inicio.

...
export class FinancialDashboardComponent implements OnInit {
  ...
  infoTexts = {
    ...
    coberturaMensual: 'Por cada mes se muestran dos barras: la azul son los ingresos percibidos y la naranja los costos totales (gastos fijos + gastos directos + honorarios). Cuando la barra azul supera a la naranja, ese mes cubriste todos los costos. La línea verde con puntos representa el saldo acumulado: la suma corrida del resultado (ingresos menos costos) de cada mes desde el inicio del historial. Un punto verde indica saldo acumulado positivo (superávit) y uno rojo, negativo (déficit). Pasá el mouse sobre una barra o un punto para ver el detalle numérico de ese mes.',

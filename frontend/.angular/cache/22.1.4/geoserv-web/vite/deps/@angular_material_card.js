import { Dc as InjectionToken, Dr as ViewEncapsulation, Hl as _defineProperty, In as Input, Ol as ɵɵdefineInjector, Ui as setClassMetadata, ba as ɵɵclassProp, cl as inject, cn as Component, do as ɵɵdomElementStart, eo as ɵɵdefineComponent, is as ɵɵprojectionDef, no as ɵɵdefineNgModule, qn as NgModule, rs as ɵɵprojection, to as ɵɵdefineDirective, uo as ɵɵdomElementEnd, wn as Directive } from "./core-M0Zz4fa8.js";
import { t as BidiModule } from "./bidi-DzTqcHeT.js";
//#region node_modules/@angular/material/fesm2022/card.mjs
var _MatCard;
var _MatCardTitle;
var _MatCardTitleGroup;
var _MatCardContent;
var _MatCardSubtitle;
var _MatCardActions;
var _MatCardHeader;
var _MatCardFooter;
var _MatCardImage;
...
_MatCard = MatCard;
_defineProperty(MatCard, "ɵfac", function MatCard_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCard)();
});
_defineProperty(MatCard, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
	type: _MatCard,
	selectors: [["mat-card"]],
	hostAttrs: [
		1,
...
_defineProperty(MatCardTitle, "ɵfac", function MatCardTitle_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardTitle)();
});
_defineProperty(MatCardTitle, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatCardTitle,
	selectors: [
		["mat-card-title"],
		[
...
_defineProperty(MatCardTitleGroup, "ɵfac", function MatCardTitleGroup_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardTitleGroup)();
});
_defineProperty(MatCardTitleGroup, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
_defineProperty(MatCardContent, "ɵfac", function MatCardContent_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardContent)();
});
_defineProperty(MatCardContent, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
_defineProperty(MatCardSubtitle, "ɵfac", function MatCardSubtitle_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardSubtitle)();
});
_defineProperty(MatCardSubtitle, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
_defineProperty(MatCardActions, "ɵfac", function MatCardActions_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardActions)();
});
_defineProperty(MatCardActions, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
_defineProperty(MatCardHeader, "ɵfac", function MatCardHeader_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardHeader)();
});
_defineProperty(MatCardHeader, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
	type: _MatCardHeader,
...
_defineProperty(MatCardFooter, "ɵfac", function MatCardFooter_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardFooter)();
});
_defineProperty(MatCardFooter, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatCardFooter,
...
_defineProperty(MatCardImage, "ɵfac", function MatCardImage_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardImage)();
});
_defineProperty(MatCardImage, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatCardImage,
	selectors: [[
		"",
		"mat-card-image",
...
_defineProperty(MatCardSmImage, "ɵfac", function MatCardSmImage_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardSmImage)();
});
_defineProperty(MatCardSmImage, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
_defineProperty(MatCardMdImage, "ɵfac", function MatCardMdImage_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardMdImage)();
});
_defineProperty(MatCardMdImage, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
_defineProperty(MatCardLgImage, "ɵfac", function MatCardLgImage_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardLgImage)();
});
_defineProperty(MatCardLgImage, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
_defineProperty(MatCardXlImage, "ɵfac", function MatCardXlImage_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardXlImage)();
});
_defineProperty(MatCardXlImage, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
_defineProperty(MatCardAvatar, "ɵfac", function MatCardAvatar_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardAvatar)();
});
_defineProperty(MatCardAvatar, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatCardAvatar,
	selectors: [[
		"",
		"mat-card-avatar",
...
_defineProperty(MatCardModule, "ɵfac", function MatCardModule_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCardModule)();
});
_defineProperty(MatCardModule, "ɵmod", /* @__PURE__ */ ɵɵdefineNgModule({
	type: _MatCardModule,
	imports: [
		MatCard,
		MatCardActions,
...
_defineProperty(MatCardModule, "ɵinj", /* @__PURE__ */ ɵɵdefineInjector({ imports: [BidiModule] }));
(() => {

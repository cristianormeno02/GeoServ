...
import { r as _getAnimationsState } from "./_animation-chunk-BUWdZVzP.js";
...
_defineProperty(MatProgressSpinner, "ɵfac", function MatProgressSpinner_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatProgressSpinner)();
});
_defineProperty(MatProgressSpinner, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
_defineProperty(MatProgressSpinnerModule, "ɵfac", function MatProgressSpinnerModule_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatProgressSpinnerModule)();
});
_defineProperty(MatProgressSpinnerModule, "ɵmod", /* @__PURE__ */ ɵɵdefineNgModule({
...
_defineProperty(MatProgressSpinnerModule, "ɵinj", /* @__PURE__ */ ɵɵdefineInjector({ imports: [BidiModule] }));
(() => {

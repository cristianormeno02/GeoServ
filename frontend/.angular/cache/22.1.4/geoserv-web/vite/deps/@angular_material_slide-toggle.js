import { $n as Output, Dc as InjectionToken, Dr as ViewEncapsulation, En as ElementRef, Fl as ɵɵnamespaceSVG, Hl as _defineProperty, In as Input, Jo as ɵɵlistener, O as booleanAttribute, Ol as ɵɵdefineInjector, S as ViewChild, Sa as ɵɵconditional, Ui as setClassMetadata, Yo as ɵɵloadQuery, _s as ɵɵqueryRefresh, as as ɵɵproperty, ba as ɵɵclassProp, bo as ɵɵelementStart, ca as ɵɵNgOnChangesFeature, cl as inject, cn as Component, eo as ɵɵdefineComponent, f as HostAttributeToken, ho as ɵɵelement, il as forwardRef, is as ɵɵprojectionDef, la as ɵɵProvidersFeature, no as ɵɵdefineNgModule, oc as ɵɵviewQuery, po as ɵɵdomProperty, qn as NgModule, r as ChangeDetectorRef, rs as ɵɵprojection, rt as numberAttribute, ua as ɵɵadvance, va as ɵɵattribute, wa as ɵɵconditionalCreate, xc as EventEmitter, ya as ɵɵclassMap, yo as ɵɵelementEnd, ys as ɵɵreference } from "./core-M0Zz4fa8.js";
...
import { n as MatRipple } from "./_ripple-chunk-BZQSgfWW.js";
...
var MatSlideToggle = class {
	...
	constructor() {
		var _defaults$hideIcon, _defaults$disabledInt;
		...
		_defineProperty(this, "defaults", inject(MAT_SLIDE_TOGGLE_DEFAULT_OPTIONS));
		...
		_defineProperty(this, "_labelId", void 0);
		_defineProperty(this, "_switchElement", void 0);
		...
		this.disabledInteractive = (_defaults$disabledInt = defaults.disabledInteractive) !== null && _defaults$disabledInt !== void 0 ? _defaults$disabledInt : false;
...
_MatSlideToggle = MatSlideToggle;
_defineProperty(MatSlideToggle, "ɵfac", function MatSlideToggle_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatSlideToggle)();
});
_defineProperty(MatSlideToggle, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
_MatSlideToggleModule = MatSlideToggleModule;
_defineProperty(MatSlideToggleModule, "ɵfac", function MatSlideToggleModule_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatSlideToggleModule)();
});
_defineProperty(MatSlideToggleModule, "ɵmod", /* @__PURE__ */ ɵɵdefineNgModule({
	type: _MatSlideToggleModule,
	imports: [MatSlideToggle],
	exports: [MatSlideToggle, BidiModule]
}));
_defineProperty(MatSlideToggleModule, "ɵinj", /* @__PURE__ */ ɵɵdefineInjector({ imports: [MatSlideToggle, BidiModule] }));
(() => {

...
var MatCheckbox = class {
	...
	constructor() {
		...
		_defineProperty(this, "_options", inject(MAT_CHECKBOX_DEFAULT_OPTIONS, { optional: true }));
		...
		_defineProperty(this, "_indeterminate", signal(false, ...ngDevMode ? [{ debugName: "_indeterminate" }] : []));
...
_defineProperty(MatCheckbox, "ɵfac", function MatCheckbox_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCheckbox)();
});
_defineProperty(MatCheckbox, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
	type: _MatCheckbox,
...
_defineProperty(MatCheckboxModule, "ɵfac", function MatCheckboxModule_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatCheckboxModule)();
});
_defineProperty(MatCheckboxModule, "ɵmod", /* @__PURE__ */ ɵɵdefineNgModule({
	type: _MatCheckboxModule,
	imports: [MatCheckbox],
	exports: [MatCheckbox, BidiModule]
}));
_defineProperty(MatCheckboxModule, "ɵinj", /* @__PURE__ */ ɵɵdefineInjector({ imports: [MatCheckbox, BidiModule] }));
(() => {

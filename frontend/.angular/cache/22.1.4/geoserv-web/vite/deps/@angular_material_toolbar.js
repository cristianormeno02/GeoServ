...
var _MatToolbarRow;
var _MatToolbar;
var _MatToolbarModule;
var _c0 = ["*", [["mat-toolbar-row"]]];
var _c1 = ["*", "mat-toolbar-row"];
var MatToolbarRow = class {};
_MatToolbarRow = MatToolbarRow;
_defineProperty(MatToolbarRow, "ɵfac", function MatToolbarRow_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatToolbarRow)();
});
_defineProperty(MatToolbarRow, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatToolbarRow,
...
_defineProperty(MatToolbar, "ɵfac", function MatToolbar_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatToolbar)();
});
_defineProperty(MatToolbar, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
	type: _MatToolbar,
...
_defineProperty(MatToolbarModule, "ɵfac", function MatToolbarModule_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatToolbarModule)();
});
_defineProperty(MatToolbarModule, "ɵmod", /* @__PURE__ */ ɵɵdefineNgModule({
...
_defineProperty(MatToolbarModule, "ɵinj", /* @__PURE__ */ ɵɵdefineInjector({ imports: [BidiModule] }));
(() => {

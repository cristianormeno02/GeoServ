...
import { t as MAT_RIPPLE_GLOBAL_OPTIONS } from "./_ripple-chunk-Bxp2ll7g.js";
...
import { t as MatRippleModule } from "./_ripple-module-chunk-CUp-Qf1u.js";
import { t as MatRippleLoader } from "./_ripple-loader-chunk-DR6d98ER.js";
...
var _MatChipAction;
var _MatChipAvatar;
var _MatChipTrailingIcon;
var _MatChipEdit;
var _MatChipRemove;
var _MatChip;
var _MatChipOption;
var _MatChipEditInput;
var _MatChipRow;
var _MatChipSet;
var _MatChipListbox;
var _MatChipGrid;
...
var MatChipContent = class {
	get disabled() {
		var _this$_parentChip;
		return this._disabled || ((_this$_parentChip = this._parentChip) === null || _this$_parentChip === void 0 ? void 0 : _this$_parentChip.disabled) || false;
	}
	set disabled(value) {
	...
	constructor() {
		...
		_defineProperty(this, "_parentChip", inject(MAT_CHIP));
		_defineProperty(this, "_isPrimary", true);
		_defineProperty(this, "_isLeading", false);
		_defineProperty(this, "_disabled", false);
		_defineProperty(this, "tabIndex", -1);
		_defineProperty(this, "_allowFocusWhenDisabled", false);
...
_MatChipContent = MatChipContent;
_defineProperty(MatChipContent, "ɵfac", function MatChipContent_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatChipContent)();
});
_defineProperty(MatChipContent, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
var MatChipAction = class extends MatChipContent {
	_getTabindex() {
...
_MatChipAction = MatChipAction;
_defineProperty(MatChipAction, "ɵfac", /* @__PURE__ */ (() => {
...
_defineProperty(MatChipAction, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatChipAction,
	selectors: [[
		"",
		"matChipAction",
...
_MatChipAvatar = MatChipAvatar;
_defineProperty(MatChipAvatar, "ɵfac", function MatChipAvatar_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatChipAvatar)();
});
_defineProperty(MatChipAvatar, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatChipAvatar,
...
var MatChipTrailingIcon = class extends MatChipContent {
	constructor(..._args) {
		super(..._args);
		_defineProperty(this, "_isPrimary", false);
	}
};
_MatChipTrailingIcon = MatChipTrailingIcon;
_defineProperty(MatChipTrailingIcon, "ɵfac", /* @__PURE__ */ (() => {
...
_defineProperty(MatChipTrailingIcon, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
var MatChipEdit = class extends MatChipAction {
	constructor(..._args2) {
		super(..._args2);
		_defineProperty(this, "_isPrimary", false);
		_defineProperty(this, "_isLeading", true);
	}
	_handleClick(event) {
		if (!this.disabled) {
...
_MatChipEdit = MatChipEdit;
_defineProperty(MatChipEdit, "ɵfac", /* @__PURE__ */ (() => {
...
_defineProperty(MatChipEdit, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatChipEdit,
	selectors: [[
		"",
		"matChipEdit",
...
var MatChipRemove = class extends MatChipAction {
	constructor(..._args3) {
		super(..._args3);
		_defineProperty(this, "_isPrimary", false);
	}
...
_MatChipRemove = MatChipRemove;
_defineProperty(MatChipRemove, "ɵfac", /* @__PURE__ */ (() => {
...
_defineProperty(MatChipRemove, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatChipRemove,
	selectors: [[
		"",
		"matChipRemove",
...
var MatChip = class {
	...
	constructor() {
		var _this$_rippleLoader;
		_defineProperty(this, "_changeDetectorRef", inject(ChangeDetectorRef));
		_defineProperty(this, "_elementRef", inject(ElementRef));
		_defineProperty(this, "_tagName", inject(HOST_TAG_NAME));
		...
		_defineProperty(this, "_isBasicChip", false);
		_defineProperty(this, "role", null);
		_defineProperty(this, "_hasFocusInternal", false);
		_defineProperty(this, "_pendingFocus", false);
		_defineProperty(this, "_actionChanges", void 0);
		_defineProperty(this, "_animationsDisabled", _animationsDisabled());
		_defineProperty(this, "_allLeadingIcons", void 0);
		_defineProperty(this, "_allTrailingIcons", void 0);
		_defineProperty(this, "_allEditIcons", void 0);
		_defineProperty(this, "_allRemoveIcons", void 0);
		_defineProperty(this, "id", inject(_IdGenerator).getId("mat-mdc-chip-"));
		_defineProperty(this, "ariaLabel", null);
		_defineProperty(this, "ariaDescription", null);
		_defineProperty(this, "_chipListDisabled", false);
		_defineProperty(this, "_hadFocusOnRemove", false);
		_defineProperty(this, "_textElement", void 0);
		_defineProperty(this, "_value", void 0);
		_defineProperty(this, "color", void 0);
		_defineProperty(this, "removable", true);
		_defineProperty(this, "highlighted", false);
		_defineProperty(this, "disableRipple", false);
		_defineProperty(this, "_disabled", false);
		_defineProperty(this, "removed", new EventEmitter());
		_defineProperty(this, "destroyed", new EventEmitter());
		_defineProperty(this, "basicChipAttrName", "mat-basic-chip");
		_defineProperty(this, "leadingIcon", void 0);
		_defineProperty(this, "editIcon", void 0);
		_defineProperty(this, "trailingIcon", void 0);
		_defineProperty(this, "removeIcon", void 0);
		_defineProperty(this, "primaryAction", void 0);
		...
		this._monitorFocus();
		(_this$_rippleLoader = this._rippleLoader) === null || _this$_rippleLoader === void 0 || _this$_rippleLoader.configureRipple(this._elementRef.nativeElement, {
	...
	ngOnDestroy() {
		var _this$_rippleLoader2, _this$_actionChanges;
		...
		(_this$_actionChanges = this._actionChanges) === null || _this$_actionChanges === void 0 || _this$_actionChanges.unsubscribe();
	}
	remove() {
		if (this.removable) {
	...
	_isRippleDisabled() {
		...
		return this.disabled || this.disableRipple || this._animationsDisabled || this._isBasicChip || !this._hasInteractiveActions() || !!((_this$_globalRippleOp = this._globalRippleOptions) === null || _this$_globalRippleOp === void 0 ? void 0 : _this$_globalRippleOp.disabled);
	}
	_hasTrailingIcon() {
...
_MatChip = MatChip;
_defineProperty(MatChip, "ɵfac", function MatChip_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatChip)();
});
_defineProperty(MatChip, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
	type: _MatChip,
	selectors: [
		["mat-basic-chip"],
		[
...
var MatChipOption = class extends MatChip {
	constructor(..._args4) {
		var _this$_defaultOptions, _this$_defaultOptions2;
		super(..._args4);
		_defineProperty(this, "_defaultOptions", inject(MAT_CHIPS_DEFAULT_OPTIONS, { optional: true }));
		_defineProperty(this, "chipListSelectable", true);
		_defineProperty(this, "_chipListMultiple", false);
		_defineProperty(this, "_chipListHideSingleSelectionIndicator", (_this$_defaultOptions = (_this$_defaultOptions2 = this._defaultOptions) === null || _this$_defaultOptions2 === void 0 ? void 0 : _this$_defaultOptions2.hideSingleSelectionIndicator) !== null && _this$_defaultOptions !== void 0 ? _this$_defaultOptions : false);
		_defineProperty(this, "_selectable", true);
		_defineProperty(this, "_selected", false);
		_defineProperty(this, "basicChipAttrName", "mat-basic-chip-option");
...
_MatChipOption = MatChipOption;
_defineProperty(MatChipOption, "ɵfac", /* @__PURE__ */ (() => {
...
_defineProperty(MatChipOption, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
	type: _MatChipOption,
	selectors: [
...
_MatChipEditInput = MatChipEditInput;
_defineProperty(MatChipEditInput, "ɵfac", function MatChipEditInput_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatChipEditInput)();
});
_defineProperty(MatChipEditInput, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
var MatChipRow = class extends MatChip {
	constructor() {
		super();
		_defineProperty(this, "basicChipAttrName", "mat-basic-chip-row");
		_defineProperty(this, "_renderer", inject(Renderer2));
		_defineProperty(this, "_cleanupMousedown", void 0);
		_defineProperty(this, "_editStartPending", false);
		_defineProperty(this, "editable", false);
		_defineProperty(this, "edited", new EventEmitter());
		_defineProperty(this, "defaultEditInput", void 0);
		_defineProperty(this, "contentEditInput", void 0);
		_defineProperty(this, "_alreadyFocused", false);
		_defineProperty(this, "_isEditing", false);
		this.role = "row";
	...
	ngOnDestroy() {
		var _this$_cleanupMousedo;
		super.ngOnDestroy();
		(_this$_cleanupMousedo = this._cleanupMousedown) === null || _this$_cleanupMousedo === void 0 || _this$_cleanupMousedo.call(this);
	}
...
_MatChipRow = MatChipRow;
_defineProperty(MatChipRow, "ɵfac", function MatChipRow_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatChipRow)();
});
_defineProperty(MatChipRow, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
	type: _MatChipRow,
	selectors: [
		["mat-chip-row"],
		[
...
var MatChipSet = class {
	constructor() {
		_defineProperty(this, "_elementRef", inject(ElementRef));
		_defineProperty(this, "_changeDetectorRef", inject(ChangeDetectorRef));
		_defineProperty(this, "_dir", inject(Directionality, { optional: true }));
		_defineProperty(this, "_lastDestroyedFocusedChipIndex", null);
		_defineProperty(this, "_keyManager", void 0);
		_defineProperty(this, "_destroyed", new Subject());
		_defineProperty(this, "_defaultRole", "presentation");
		_defineProperty(this, "_disabled", false);
		_defineProperty(this, "tabIndex", 0);
		_defineProperty(this, "_explicitRole", null);
		_defineProperty(this, "_chips", void 0);
		_defineProperty(this, "_chipActions", new QueryList());
	}
	...
	_syncChipsState() {
		var _this$_chips;
		(_this$_chips = this._chips) === null || _this$_chips === void 0 || _this$_chips.forEach((chip) => {
	...
	_setUpFocusManagement() {
		...
		(_this$_dir = this._dir) === null || _this$_dir === void 0 || _this$_dir.change.pipe(takeUntil(this._destroyed)).subscribe((direction) => this._keyManager.withHorizontalOrientation(direction));
	}
...
_MatChipSet = MatChipSet;
_defineProperty(MatChipSet, "ɵfac", function MatChipSet_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatChipSet)();
});
_defineProperty(MatChipSet, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
	type: _MatChipSet,
...
var MatChipListbox = class extends MatChipSet {
	constructor(..._args5) {
		var _this$_defaultOptions3, _this$_defaultOptions4;
		super(..._args5);
		_defineProperty(this, "_onTouched", () => {});
		_defineProperty(this, "_onChange", () => {});
		_defineProperty(this, "_defaultRole", "listbox");
		_defineProperty(this, "_defaultOptions", inject(MAT_CHIPS_DEFAULT_OPTIONS, { optional: true }));
		_defineProperty(this, "_multiple", false);
		_defineProperty(this, "ariaOrientation", "horizontal");
		_defineProperty(this, "_selectable", true);
		_defineProperty(this, "compareWith", (o1, o2) => o1 === o2);
		_defineProperty(this, "required", false);
		_defineProperty(this, "_hideSingleSelectionIndicator", (_this$_defaultOptions3 = (_this$_defaultOptions4 = this._defaultOptions) === null || _this$_defaultOptions4 === void 0 ? void 0 : _this$_defaultOptions4.hideSingleSelectionIndicator) !== null && _this$_defaultOptions3 !== void 0 ? _this$_defaultOptions3 : false);
		_defineProperty(this, "_value", void 0);
...
_MatChipListbox = MatChipListbox;
_defineProperty(MatChipListbox, "ɵfac", /* @__PURE__ */ (() => {
...
_defineProperty(MatChipListbox, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
var MatChipGrid = class extends MatChipSet {
	get disabled() {
	...
	get focused() {
		...
		return ((_this$_chipInput = this._chipInput) === null || _this$_chipInput === void 0 ? void 0 : _this$_chipInput.focused) || this._hasFocusedChip();
	}
	get required() {
	...
	constructor() {
		...
		_defineProperty(this, "controlType", "mat-chip-grid");
		_defineProperty(this, "_chipInput", void 0);
		_defineProperty(this, "_defaultRole", "grid");
		_defineProperty(this, "_errorStateTracker", void 0);
		_defineProperty(this, "_uid", inject(_IdGenerator).getId("mat-chip-grid-"));
		_defineProperty(this, "_ariaDescribedbyIds", []);
		_defineProperty(this, "_onTouched", () => {});
		_defineProperty(this, "_onChange", () => {});
	...
	focus() {
		var _this$_chipInput2;
		if (this.disabled || ((_this$_chipInput2 = this._chipInput) === null || _this$_chipInput2 === void 0 ? void 0 : _this$_chipInput2.focused)) return;
	...
	_allowFocusEscape() {
		var _this$_chipInput3;
		if (!((_this$_chipInput3 = this._chipInput) === null || _this$_chipInput3 === void 0 ? void 0 : _this$_chipInput3.focused)) super._allowFocusEscape();
	}
	_handleKeydown(event) {
		var _this$_chipInput5;
		const keyCode = event.keyCode;
		const activeItem = this._keyManager.activeItem;
		if (keyCode === 9) {
			var _this$_chipInput4;
			if (((_this$_chipInput4 = this._chipInput) === null || _this$_chipInput4 === void 0 ? void 0 : _this$_chipInput4.focused) && hasModifierKey(event, "shiftKey") && this._chips.length && !this._chips.last.disabled) {
				event.preventDefault();
				if (activeItem) this._keyManager.setActiveItem(activeItem);
				else this._focusLastChip();
			} else super._allowFocusEscape();
		} else if (!((_this$_chipInput5 = this._chipInput) === null || _this$_chipInput5 === void 0 ? void 0 : _this$_chipInput5.focused)) if ((keyCode === 38 || keyCode === 40) && activeItem) {
...
_MatChipGrid = MatChipGrid;
_defineProperty(MatChipGrid, "ɵfac", function MatChipGrid_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatChipGrid)();
});
_defineProperty(MatChipGrid, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
	type: _MatChipGrid,
...
var MatChipInput = class {
	...
	constructor() {
		var _defaultOptions$input;
		_defineProperty(this, "_elementRef", inject(ElementRef));
		_defineProperty(this, "focused", false);
		_defineProperty(this, "_chipGrid", void 0);
		_defineProperty(this, "addOnBlur", false);
		_defineProperty(this, "separatorKeyCodes", void 0);
		_defineProperty(this, "chipEnd", new EventEmitter());
		_defineProperty(this, "placeholder", "");
		_defineProperty(this, "id", inject(_IdGenerator).getId("mat-mdc-chip-list-input-"));
		_defineProperty(this, "_disabled", false);
		...
		this.disabledInteractive = (_defaultOptions$input = defaultOptions.inputDisabledInteractive) !== null && _defaultOptions$input !== void 0 ? _defaultOptions$input : false;
	...
	_isSeparatorKey(event) {
		...
		for (const key of this.separatorKeyCodes) {
			...
			const modifiersMatch = !(modifiers === null || modifiers === void 0 ? void 0 : modifiers.length) ? !hasModifierKey(event) : hasModifierKey(event, ...modifiers);
...
_MatChipInput = MatChipInput;
_defineProperty(MatChipInput, "ɵfac", function MatChipInput_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatChipInput)();
});
_defineProperty(MatChipInput, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatChipInput,
	selectors: [[
		"input",
		"matChipInputFor",
...
_MatChipsModule = MatChipsModule;
_defineProperty(MatChipsModule, "ɵfac", function MatChipsModule_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatChipsModule)();
});
_defineProperty(MatChipsModule, "ɵmod", /* @__PURE__ */ ɵɵdefineNgModule({
...
_defineProperty(MatChipsModule, "ɵinj", /* @__PURE__ */ ɵɵdefineInjector({

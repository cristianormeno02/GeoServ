...
import { _ as ViewportRuler, i as CdkScrollableModule, r as CdkScrollable } from "./scrolling-BsTEyEGe.js";
import { a as FocusTrapFactory, o as InteractivityChecker, p as FocusMonitor, t as _animationsDisabled } from "./_animation-chunk-BiCAYLDt.js";
...
var _MatDrawer;
var _MatDrawerContainer;
var _MatSidenavContent;
var _MatSidenav;
var _MatSidenavContainer;
var _MatSidenavModule;
var _c0 = ["*"];
var _c1 = ["content"];
var _c2 = [
...
var MatDrawerContent = class extends CdkScrollable {
	constructor(..._args) {
		...
		_defineProperty(this, "_isInert", false);
		_defineProperty(this, "_container", inject(MatDrawerContainer));
	}
	ngAfterContentInit() {
...
_MatDrawerContent = MatDrawerContent;
_defineProperty(MatDrawerContent, "ɵfac", /* @__PURE__ */ (() => {
...
_defineProperty(MatDrawerContent, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
var MatDrawer = class {
	...
	set mode(value) {
		...
		(_this$_getContent = this._getContent()) === null || _this$_getContent === void 0 || _this$_getContent._drawerModeChanged();
	}
	get disableClose() {
	...
	constructor() {
		...
		_defineProperty(this, "_container", inject(MAT_DRAWER_CONTAINER, { optional: true }));
		_defineProperty(this, "_focusTrap", null);
		_defineProperty(this, "_elementFocusedBeforeDrawerWasOpened", null);
		_defineProperty(this, "_eventCleanups", void 0);
		_defineProperty(this, "_isAttached", false);
		_defineProperty(this, "_anchor", null);
		_defineProperty(this, "_position", "start");
		_defineProperty(this, "_mode", "over");
		_defineProperty(this, "_disableClose", false);
		_defineProperty(this, "_autoFocus", void 0);
		_defineProperty(this, "_opened", signal(false, ...ngDevMode ? [{ debugName: "_opened" }] : []));
		_defineProperty(this, "_openedVia", null);
		_defineProperty(this, "_animationStarted", new Subject());
		_defineProperty(this, "_animationEnd", new Subject());
		_defineProperty(this, "openedChange", new EventEmitter(true));
		_defineProperty(this, "_openedStream", this.openedChange.pipe(filter((o) => o), map(() => {})));
		_defineProperty(this, "openedStart", this._animationStarted.pipe(filter(() => this.opened), mapTo(void 0)));
		_defineProperty(this, "_closedStream", this.openedChange.pipe(filter((o) => !o), map(() => {})));
		_defineProperty(this, "closedStart", this._animationStarted.pipe(filter(() => !this.opened), mapTo(void 0)));
		_defineProperty(this, "_destroyed", new Subject());
		_defineProperty(this, "onPositionChanged", new EventEmitter());
		_defineProperty(this, "_content", void 0);
		_defineProperty(this, "_modeChanged", new Subject());
		_defineProperty(this, "_injector", inject(Injector));
		_defineProperty(this, "_changeDetectorRef", inject(ChangeDetectorRef));
		_defineProperty(this, "_handleTransitionEvent", (event) => {
	...
	ngOnDestroy() {
		var _this$_focusTrap, _this$_anchor;
		this._eventCleanups.forEach((cleanup) => cleanup());
		(_this$_focusTrap = this._focusTrap) === null || _this$_focusTrap === void 0 || _this$_focusTrap.destroy();
	...
	_setOpen(isOpen, restoreFocus, focusOrigin) {
		var _this$_getContent2, _this$_container;
		if (isOpen === this.opened) return Promise.resolve(isOpen ? "open" : "close");
		this._opened.set(isOpen);
		(_this$_getContent2 = this._getContent()) === null || _this$_getContent2 === void 0 || _this$_getContent2._drawerToggled(this);
		if ((_this$_container = this._container) === null || _this$_container === void 0 ? void 0 : _this$_container._transitionsEnabled) {
	...
	_getContent() {
		var _this$_container2, _this$_container3;
		return ((_this$_container2 = this._container) === null || _this$_container2 === void 0 ? void 0 : _this$_container2._content) || ((_this$_container3 = this._container) === null || _this$_container3 === void 0 ? void 0 : _this$_container3._userContent);
	}
	...
	_updateFocusTrapState() {
		if (this._focusTrap) {
			var _this$_container4;
			this._focusTrap.enabled = this.opened && !!((_this$_container4 = this._container) === null || _this$_container4 === void 0 ? void 0 : _this$_container4._isShowingBackdrop());
		}
	}
...
_MatDrawer = MatDrawer;
_defineProperty(MatDrawer, "ɵfac", function MatDrawer_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatDrawer)();
});
_defineProperty(MatDrawer, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
	type: _MatDrawer,
...
var MatDrawerContainer = class {
	...
	constructor() {
		...
		_defineProperty(this, "_transitionsEnabled", false);
		_defineProperty(this, "_allDrawers", void 0);
		_defineProperty(this, "_drawers", new QueryList());
		_defineProperty(this, "_content", void 0);
		_defineProperty(this, "_userContent", void 0);
		_defineProperty(this, "_autosize", inject(MAT_DRAWER_DEFAULT_AUTOSIZE));
		_defineProperty(this, "_backdropOverride", null);
		_defineProperty(this, "backdropClick", new EventEmitter());
		_defineProperty(this, "_start", null);
		_defineProperty(this, "_end", null);
		_defineProperty(this, "_left", null);
		_defineProperty(this, "_right", null);
		_defineProperty(this, "_destroyed", new Subject());
		_defineProperty(this, "_doCheckSubject", new Subject());
		_defineProperty(this, "_contentMargins", {
			left: null,
			right: null
		});
		_defineProperty(this, "_contentMarginChanges", new Subject());
		_defineProperty(this, "_injector", inject(Injector));
		const platform = inject(Platform);
		const viewportRuler = inject(ViewportRuler);
		(_this$_dir = this._dir) === null || _this$_dir === void 0 || _this$_dir.change.pipe(takeUntil(this._destroyed)).subscribe(() => {
...
_MatDrawerContainer = MatDrawerContainer;
_defineProperty(MatDrawerContainer, "ɵfac", function MatDrawerContainer_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatDrawerContainer)();
});
_defineProperty(MatDrawerContainer, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
_MatSidenavContent = MatSidenavContent;
_defineProperty(MatSidenavContent, "ɵfac", /* @__PURE__ */ (() => {
...
_defineProperty(MatSidenavContent, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
var MatSidenav = class extends MatDrawer {
	constructor(..._args2) {
		super(..._args2);
		_defineProperty(this, "_fixedInViewport", false);
		_defineProperty(this, "_fixedTopGap", 0);
		_defineProperty(this, "_fixedBottomGap", 0);
	}
	get fixedInViewport() {
...
_MatSidenav = MatSidenav;
_defineProperty(MatSidenav, "ɵfac", /* @__PURE__ */ (() => {
...
_defineProperty(MatSidenav, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
	type: _MatSidenav,
...
_MatSidenavContainer = MatSidenavContainer;
_defineProperty(MatSidenavContainer, "ɵfac", /* @__PURE__ */ (() => {
...
_defineProperty(MatSidenavContainer, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
_MatSidenavModule = MatSidenavModule;
_defineProperty(MatSidenavModule, "ɵfac", function MatSidenavModule_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatSidenavModule)();
});
_defineProperty(MatSidenavModule, "ɵmod", /* @__PURE__ */ ɵɵdefineNgModule({
...
_defineProperty(MatSidenavModule, "ɵinj", /* @__PURE__ */ ɵɵdefineInjector({ imports: [
	CdkScrollableModule,
	BidiModule,
	CdkScrollableModule
] }));

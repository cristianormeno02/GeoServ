...
import { n as Breakpoints, s as LiveAnnouncer, t as _animationsDisabled, u as BreakpointObserver } from "./_animation-chunk-BiCAYLDt.js";
import "./private-D5SPIAUl.js";
import { t as _IdGenerator } from "./_id-generator-chunk-Cnm3ZUPn.js";
import { _ as TemplatePortal, d as createOverlayRef, g as PortalModule, h as ComponentPortal, i as OverlayConfig, m as CdkPortalOutlet, o as OverlayModule, p as BasePortalOutlet, u as createGlobalPositionStrategy } from "./overlay-YnQO9DaH.js";
import "./platform-Dcm7u2Id.js";
import { i as MatButtonModule, r as MatButton } from "./button-BI4Rx5Qn.js";
//#region node_modules/@angular/material/fesm2022/snack-bar.mjs
var _MatSnackBarLabel;
var _MatSnackBarActions;
var _MatSnackBarAction;
var _SimpleSnackBar;
var _MatSnackBarContainer;
var _MatSnackBar;
var _MatSnackBarModule;
...
var MatSnackBarConfig = class {
	constructor() {
		_defineProperty(this, "politeness", "polite");
...
var MatSnackBarLabel = class {};
_MatSnackBarLabel = MatSnackBarLabel;
_defineProperty(MatSnackBarLabel, "ɵfac", function MatSnackBarLabel_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatSnackBarLabel)();
});
_defineProperty(MatSnackBarLabel, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
var MatSnackBarActions = class {};
_MatSnackBarActions = MatSnackBarActions;
_defineProperty(MatSnackBarActions, "ɵfac", function MatSnackBarActions_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatSnackBarActions)();
});
_defineProperty(MatSnackBarActions, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
var MatSnackBarAction = class {};
_MatSnackBarAction = MatSnackBarAction;
_defineProperty(MatSnackBarAction, "ɵfac", function MatSnackBarAction_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatSnackBarAction)();
});
_defineProperty(MatSnackBarAction, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
_defineProperty(SimpleSnackBar, "ɵfac", function SimpleSnackBar_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _SimpleSnackBar)();
});
_defineProperty(SimpleSnackBar, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
var MatSnackBarContainer = class extends BasePortalOutlet {
	constructor() {
		...
		_defineProperty(this, "_trackedModals", /* @__PURE__ */ new Set());
		...
		this._ngZone.runOutsideAngular(() => {
			this._announceTimeoutId = setTimeout(() => {
				...
				if (inertElement && liveElement) {
					...
					focusedElement === null || focusedElement === void 0 || focusedElement.focus();
...
_defineProperty(MatSnackBarContainer, "ɵfac", function MatSnackBarContainer_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatSnackBarContainer)();
});
_defineProperty(MatSnackBarContainer, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
var MatSnackBar = class MatSnackBar {
	...
	open(message, action = "", config) {
		const _config = _objectSpread2(_objectSpread2({}, this._defaultConfig), config);
		_config.data = {
			message,
			action
		};
	...
	_attach(content, userConfig) {
		const config = _objectSpread2(_objectSpread2(_objectSpread2({}, new MatSnackBarConfig()), this._defaultConfig), userConfig);
...
_defineProperty(MatSnackBar, "ɵfac", function MatSnackBar_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatSnackBar)();
});
_defineProperty(MatSnackBar, "ɵprov", /* @__PURE__ */ ɵɵdefineService({
	token: _MatSnackBar,
...
_defineProperty(MatSnackBarModule, "ɵfac", function MatSnackBarModule_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatSnackBarModule)();
});
_defineProperty(MatSnackBarModule, "ɵmod", /* @__PURE__ */ ɵɵdefineNgModule({
...
_defineProperty(MatSnackBarModule, "ɵinj", /* @__PURE__ */ ɵɵdefineInjector({

import { A as contentChild, Bt as computed, Dc as InjectionToken, Dr as ViewEncapsulation, Ea as ɵɵcontentQuerySignal, En as ElementRef, Hl as _defineProperty, Hs as ɵɵtemplateRefExtractor, Ic as NgZone, In as Input, Jo as ɵɵlistener, S as ViewChild, Sa as ɵɵconditional, Sl as signal, T as afterRenderEffect, Ta as ɵɵcontentQuery, Ui as setClassMetadata, Us as ɵɵtext, Vs as ɵɵtemplate, Ws as ɵɵtextInterpolate, Xo as ɵɵnextContext, Yo as ɵɵloadQuery, _s as ɵɵqueryRefresh, a as ContentChildren, as as ɵɵproperty, ba as ɵɵclassProp, bo as ɵɵelementStart, cl as inject, cn as Component, do as ɵɵdomElementStart, eo as ɵɵdefineComponent, gs as ɵɵqueryAdvance, gt as viewChild, ho as ɵɵelement, i as ContentChild, il as forwardRef, ir as Renderer2, is as ɵɵprojectionDef, la as ɵɵProvidersFeature, nl as effect, oc as ɵɵviewQuery, oo as ɵɵdomElement, po as ɵɵdomProperty, r as ChangeDetectorRef, rs as ɵɵprojection, sc as ɵɵviewQuerySignal, to as ɵɵdefineDirective, ua as ɵɵadvance, uo as ɵɵdomElementEnd, va as ɵɵattribute, wa as ɵɵconditionalCreate, wn as Directive, yo as ɵɵelementEnd, ys as ɵɵreference } from "./core-_xwmo-Ov.js";
import { Qt as filter, S as startWith, W as pairwise, Wn as Subject, _ as takeUntil, fn as map, rr as Subscription } from "./zipWith-DkrnN79P.js";
import { s as merge } from "./esm5-1bPjeIHk.js";
import { i as Directionality } from "./bidi-DuFmUtxN.js";
...
var _MatPrefix;
var _MatSuffix;
var _MatFormFieldFloatingLabel;
var _MatFormFieldLineRipple;
var _MatFormFieldNotchedOutline;
var _MatFormFieldControl;
var _MatFormField;
var _c0 = ["notch"];
var _c1 = ["*"];
...
var MatLabel = class {};
_MatLabel = MatLabel;
_defineProperty(MatLabel, "ɵfac", function MatLabel_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatLabel)();
});
_defineProperty(MatLabel, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatLabel,
	selectors: [["mat-label"]]
}));
(() => {
...
_MatError = MatError;
_defineProperty(MatError, "ɵfac", function MatError_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatError)();
});
_defineProperty(MatError, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatError,
	selectors: [["mat-error"], [
		"",
		"matError",
...
_MatHint = MatHint;
_defineProperty(MatHint, "ɵfac", function MatHint_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatHint)();
});
_defineProperty(MatHint, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatHint,
	selectors: [["mat-hint"]],
	hostAttrs: [
		1,
...
_defineProperty(MatPrefix, "ɵfac", function MatPrefix_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatPrefix)();
});
_defineProperty(MatPrefix, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatPrefix,
	selectors: [
		[
			"",
...
_defineProperty(MatSuffix, "ɵfac", function MatSuffix_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatSuffix)();
});
_defineProperty(MatSuffix, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _MatSuffix,
	selectors: [
		[
			"",
...
var MatFormFieldFloatingLabel = class {
	constructor() {
...
_defineProperty(MatFormFieldFloatingLabel, "ɵfac", function MatFormFieldFloatingLabel_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatFormFieldFloatingLabel)();
});
_defineProperty(MatFormFieldFloatingLabel, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
var MatFormFieldLineRipple = class {
	constructor() {
		_defineProperty(this, "_elementRef", inject(ElementRef));
...
_defineProperty(MatFormFieldLineRipple, "ɵfac", function MatFormFieldLineRipple_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatFormFieldLineRipple)();
});
_defineProperty(MatFormFieldLineRipple, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
...
var MatFormFieldNotchedOutline = class {
	constructor() {
		_defineProperty(this, "_elementRef", inject(ElementRef));
		_defineProperty(this, "_ngZone", inject(NgZone));
...
_defineProperty(MatFormFieldNotchedOutline, "ɵfac", function MatFormFieldNotchedOutline_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatFormFieldNotchedOutline)();
});
_defineProperty(MatFormFieldNotchedOutline, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
...
var MatFormFieldControl = class {
	constructor() {
		...
		_defineProperty(this, "shouldLabelFloat", false);
		...
		_defineProperty(this, "describedByIds", void 0);
	}
};
_MatFormFieldControl = MatFormFieldControl;
_defineProperty(MatFormFieldControl, "ɵfac", function MatFormFieldControl_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatFormFieldControl)();
});
_defineProperty(MatFormFieldControl, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({ type: _MatFormFieldControl }));
(() => {
...
var MatFormField = class {
	...
	constructor() {
		...
		_defineProperty(this, "_ngZone", inject(NgZone));
		_defineProperty(this, "_defaults", inject(MAT_FORM_FIELD_DEFAULT_OPTIONS, { optional: true }));
		...
		_defineProperty(this, "_iconPrefixContainerSignal", viewChild("iconPrefixContainer", ...ngDevMode ? [{ debugName: "_iconPrefixContainerSignal" }] : []));
		_defineProperty(this, "_textPrefixContainerSignal", viewChild("textPrefixContainer", ...ngDevMode ? [{ debugName: "_textPrefixContainerSignal" }] : []));
		_defineProperty(this, "_iconSuffixContainerSignal", viewChild("iconSuffixContainer", ...ngDevMode ? [{ debugName: "_iconSuffixContainerSignal" }] : []));
		_defineProperty(this, "_textSuffixContainerSignal", viewChild("textSuffixContainer", ...ngDevMode ? [{ debugName: "_textSuffixContainerSignal" }] : []));
		_defineProperty(this, "_prefixSuffixContainers", computed(() => {
			return [
			...
			].map((container) => container === null || container === void 0 ? void 0 : container.nativeElement).filter((e) => e !== void 0);
		...
		_defineProperty(this, "_labelChild", contentChild(MatLabel, ...ngDevMode ? [{ debugName: "_labelChild" }] : []));
		_defineProperty(this, "_hideRequiredMarker", false);
		_defineProperty(this, "color", "primary");
		_defineProperty(this, "_floatLabel", void 0);
		_defineProperty(this, "_appearanceSignal", signal(DEFAULT_APPEARANCE, ...ngDevMode ? [{ debugName: "_appearanceSignal" }] : []));
		...
		_defineProperty(this, "_describedByIds", void 0);
		...
		_defineProperty(this, "_outlineLabelOffsetResizeObserver", null);
		_defineProperty(this, "_animationsDisabled", _animationsDisabled());
		_defineProperty(this, "getLabelId", computed(() => this._hasFloatingLabel() ? this._labelId : null, ...ngDevMode ? [{ debugName: "getLabelId" }] : []));
		_defineProperty(this, "_hasFloatingLabel", computed(() => !!this._labelChild(), ...ngDevMode ? [{ debugName: "_hasFloatingLabel" }] : []));
	...
	ngOnDestroy() {
		var _this$_outlineLabelOf, _this$_stateChanges, _this$_valueChanges, _this$_describedByCha;
		(_this$_outlineLabelOf = this._outlineLabelOffsetResizeObserver) === null || _this$_outlineLabelOf === void 0 || _this$_outlineLabelOf.disconnect();
	...
	_updateFocusState() {
		...
		(_this$_textField = this._textField) === null || _this$_textField === void 0 || _this$_textField.nativeElement.classList.toggle("mdc-text-field--focused", controlFocused);
	}
	_syncOutlineLabelOffset() {
		afterRenderEffect({
			earlyRead: () => {
				if (this._appearanceSignal() !== "outline") {
					var _this$_outlineLabelOf2;
					(_this$_outlineLabelOf2 = this._outlineLabelOffsetResizeObserver) === null || _this$_outlineLabelOf2 === void 0 || _this$_outlineLabelOf2.disconnect();
					return null;
				}
	...
	_writeOutlinedLabelStyles(styles) {
		if (styles !== null) {
			...
			if (notchedOutlineWidth !== null) {
				var _this$_notchedOutline3;
				(_this$_notchedOutline3 = this._notchedOutline) === null || _this$_notchedOutline3 === void 0 || _this$_notchedOutline3._setMaxWidth(notchedOutlineWidth);
			}
		}
	}
	_isAttachedToDom() {
...
_defineProperty(MatFormField, "ɵfac", function MatFormField_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _MatFormField)();
});
_defineProperty(MatFormField, "ɵcmp", /* @__PURE__ */ ɵɵdefineComponent({
	type: _MatFormField,

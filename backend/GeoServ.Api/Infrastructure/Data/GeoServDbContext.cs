...
public class GeoServDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MovementCategory>().HasData(
            new MovementCategory { Id = Guid.Parse("A1111111-1111-1111-1111-111111111111"), Name = "Cobro de Orden de Servicio", Description = "Ingreso por trabajos realizados", IsIncome = true, IsActive = true, IsSystemDefault = false },
            ...
            new MovementCategory { Id = Guid.Parse("A6666666-6666-6666-6666-666666666666"), Name = "Pago de Gasto Fijo", Description = "Luz, internet, alquiler", IsIncome = false, IsActive = true, IsSystemDefault = false },
            new MovementCategory { Id = Guid.Parse("A7777777-7777-7777-7777-777777777777"), Name = "Pago de Costo Directo", Description = "Insumos para obras", IsIncome = false, IsActive = true, IsSystemDefault = false },
            new MovementCategory { Id = Guid.Parse("A8888888-8888-8888-8888-888888888888"), Name = "Compra de Activo", Description = "Equipamiento, rodados", IsIncome = false, IsActive = true, IsSystemDefault = false },

...
namespace GeoServ.Api.Migrations
{
    ...
    [Migration("20260921014511_AddPasswordResetTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GeoServ.Api.Domain.Entities.AccountingMovement", b =>
                {
                    ...
                    b.Property<Guid?>("FixedCostPaymentId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GeoServ.Api.Domain.Entities.DirectCost", b =>
                {
                    ...
                    b.Property<bool>("IsFromMovement")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("GeoServ.Api.Domain.Entities.DirectCostCategory", b =>
                {
                    ...
                    b.Property<bool>("IsAssignableViaMovement")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("GeoServ.Api.Domain.Entities.MovementCategory", b =>
                {
                    ...
                    b.Property<string>("LinkedSourceType")
                        .HasColumnType("text");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LinkedSourceType = "ServiceOrderIncome",
                        ...
                        new
                        {
                            ...
                            IsIncome = false,
                            IsSystemDefault = false,
                            LinkedSourceType = "FixedCostPayment",
                        ...
                        new
                        {
                            ...
                            IsIncome = false,
                            IsSystemDefault = false,
                            LinkedSourceType = "AssetPurchase",
            ...
            modelBuilder.Entity("GeoServ.Api.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GeoServ.Api.Domain.Entities.UserMenuFavorite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "MenuPath")
                        .IsUnique();

                    b.ToTable("UserMenuFavorites");
                });
            ...
            modelBuilder.Entity("GeoServ.Api.Domain.Entities.AccountingMovement", b =>
                {
                    ...
                    b.HasOne("GeoServ.Api.Domain.Entities.FixedCostPayment", "FixedCostPayment")
                        .WithMany()
                        .HasForeignKey("FixedCostPaymentId")
